...
alias cs='clear'
alias cz='cat ~/.zshrc'
alias gpa='cp -rf ~/.config/alacritty/* ~/Documents/Git/alacritty/ && cp -rf ~/.config/kitty/* ~/Documents/Git/kitty/ && cp -rf ~/.config/nvim/* ~/Documents/Git/nvim/ && cp -rf ~/.config/yazi/* ~/Documents/Git/yazi/ && cp -f ~/.zshrc ~/Documents/Git/zshrc/ && for d in alacritty kitty nvim yazi zshrc; do cd ~/Documents/Git/$d && find . -name ".DS_Store" -type f -delete && git add -A && (git diff --cached --quiet && echo "$d: no changes to commit" || git commit -m "update $(date +%Y-%m-%d)") && echo "\n************  Gitee  ************\n" && git push gitee && echo "\n************  GitHub  ************\n" && git push github; done && cd ~/Documents/Git/zshrc && echo "All configs synced and pushed."'
alias e='exit'
alias f='fzf'
alias g='git'
alias gdd='git add .'
