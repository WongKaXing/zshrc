...
alias cs='clear'
alias cz='cat ~/.zshrc'
alias syncfg='cp -rf ~/.config/kitty/* ~/Documents/Git/kitty/ && cp -rf ~/.config/yazi/* ~/Documents/Git/yazi/ && cp -rf ~/.config/nvim/* ~/Documents/Git/nvim/ && cp -f ~/.zshrc ~/Documents/Git/zshrc/ && for d in kitty yazi nvim zshrc; do cd ~/Documents/Git/$d && find . -name ".DS_Store" -type f -delete && git add -A && (git diff --cached --quiet && echo "$d: no changes to commit" || git commit -m "update $(date +%Y-%m-%d)") && git push gitee && git push github; done && cd ~/Documents/Git/zshrc && echo "All configs synced and pushed."'
alias e='exit'
alias f='fzf'
alias g='git'
alias gdd='git add .'
